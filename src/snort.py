...
class Snort(object):
    ...
    def __init__(self):
        """ Sets the path to snort.  Try all the possible paths in _config_paths"""
        self._command = list()
        ...
        for config_path in self._config_paths:
            if os.path.isfile(config_path):
                ...
                self._command.append(config['snort_path'])
                return
    ...
    def capture(self, command):
        ...
        :param command: snort command to execute
    ...
    def make_command(self, nic, count, bpf, pcap_file, interfaces):
        """ Builds a snort command to execute.
        ...
        :return: snort with arguments array
        """
    ...
    def _drop_index_line(self, line):
        """ Drops the bulk index line from the snort packet output
